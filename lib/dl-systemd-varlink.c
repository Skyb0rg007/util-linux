...
{
	UL_DLSYM( ul_libsystemd_opers, sd_varlink_connect_address ),
	UL_DLSYM( ul_libsystemd_opers, sd_varlink_set_allow_fd_passing_output ),
	UL_DLSYM( ul_libsystemd_opers, sd_varlink_push_dup_fd ),
	UL_DLSYM( ul_libsystemd_opers, sd_varlink_callb ),
	UL_DLSYM( ul_libsystemd_opers, sd_varlink_close_unref ),
	UL_DLSYM( ul_libsystemd_opers, sd_json_variant_unref ),
	UL_DLSYM( ul_libsystemd_opers, sd_json_variant_format ),
};
